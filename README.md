...
### Example Run
    ...
    docker run -d -p 27001:27001 -p 27002:27002 -p 27003:27003 -v /data/mongodb:/data -e "REPLICA_SET_NAME=mongo-rs" -e "USERNAME=dev" -e "PASSWORD=dev" --restart=always luamas/docker-mongo-local-replicaset --name mongo
